...
const Post = () => {
  ...
  return (
    <div className="post flex items-end">
      <div className="w-full h-3/5 bg-[#ffffff] rounded-[48px] p-6 flex flex-col items-center justify-center">
        <svg
          width="207"
          height="168"
          viewBox="0 0 207 168"
        ...
        <div>
          ...
          <Link to="/login">
            <p
              className="text-[#878787] text-center mt-4"
